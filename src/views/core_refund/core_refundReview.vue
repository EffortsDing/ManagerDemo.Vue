    ...
    <section>
        <el-col :span="24" class="toolbar" style="padding-bottom: 0px">
            <el-form :inline="true" :model="filters">
                ...
                <el-form-item  prop="postStatus" label="审核状态">
                ...
                <el-form-item>
                    <el-button type="primary" v-on:click="getList" >审核</el-button>
                </el-form-item>
            </el-form>
        </el-col>
       ...
       <el-table id="out-table" :data="tableData" @selection-change="selsChange" highlight-current-row v-loading="listLoading" border style="width: 100%">
            ...
            <el-table-column prop="CREATE_TIME" label="创建时间" :formatter="dateFormat">
            </el-table-column>
  ...
  data() {
    return {
      ...
      tableData: [
        {
          BILLNO: "123",
          CREATE_TIME: "/Date(1533052800000)/",
          CREATE_USERID: "123",
          UPDATE_TIME: "123",
          UPDATE_USERID: "123",
          INPUTKIND: "123",
